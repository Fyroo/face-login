  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-methods">
        <button
          :class="['method-tab', { active: loginMethod === 'credentials' }]"
        ...
        <button
          :class="['method-tab', { active: loginMethod === 'face' }]"
      ...
      <div v-else class="face-login">
        ...
        <div v-else class="upload-section">
          ...
          >
            ...
            <p class="upload-description">Select a clear photo of your face</p>
        ...
        <div v-if="capturedImage" class="captured-preview">
          ...
          >
            <span v-if="isLoading" class="loading-spinner"></span>
            {{ isLoading ? "Authenticating..." : "Sign in with Face" }}
          </button>
        </div>
      </div>
